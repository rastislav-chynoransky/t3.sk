    ...
    <div class="flex flex-wrap">
      <div class="lg:w-1/2 px-8">
        <div class="max-w-sm">
          ...
          <p class="mt-3">T3 je otvorené vašim nápadom či žiadostiam o prenájom. V prípade záujmu o využitie nášho priestoru nás kontaktujte. Ak váš projekt/podujatie zapadá do našej dramaturgie, vieme sa dohodnúť na veľmi priaznivých podmienkach.</p>
        </div>
      ...
      <div class="lg:w-1/2 px-8">
        ...
        <table class="mt-3">
          <tr>
            ...
            <td><a class="underline hover:no-underline" href="mailto:prostriedok.t3@gmail.com" target="_blank">prostriedok.t3@gmail.com</a></td>
          </tr>
          <tr>
            <td class="pr-3">instagram</td>
            <td><a class="underline hover:no-underline" href="https://www.instagram.com/t3kulturnyprostriedok/" target="_blank">@t3kulturnyprostriedok</a></td>
          </tr>
          <tr>
            <td class="pr-3">facebook</td>
            <td><a class="underline hover:no-underline" href="https://fb.me/T3.kulturny.prostriedok" target="_blank">T3.kulturny.prostriedok</a></td>
          </tr>
        </table>
